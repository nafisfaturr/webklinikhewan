...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        <h4 class = "mb-4">Artikel Admin</h4>
        <div class="text-end me-5 mb-3"><button class="btn btn-warning" onclick= "tambahMenu()">Tambah Laporan</button></div>
        <div class="tabel-responsive">
          <table class = "table">
            ...
            <tr>
                <td><img src="<%= allrecord.getGambar()%>"></td>
              <td><%= allrecord.getJudul_artikel()%></td>
